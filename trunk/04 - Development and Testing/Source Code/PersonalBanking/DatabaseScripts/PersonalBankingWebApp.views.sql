...
/****** Object:  View [dbo].[cnsAccountTransactionsPerUserUSDollars]    Script Date: 01/15/2012 13:38:26 ******/
...
/****** Object:  View [dbo].[cnsEvents]    Script Date: 01/15/2012 13:38:26 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[cnsEvents]'))
DROP VIEW [dbo].[cnsEvents]
GO
...
where
	Deposits.Account = Withdrawls.Account and Deposits.webUser = Withdrawls.webUser 
...
create view [dbo].[cnsEvents] as
select wue.*, wu.lastName + ',' + wu.firstName as WebUserName,
ec.name as EventLevelCatalog 
from webUserEvent wue,
webUser wu, EventLevelCatalog ec
where
wue.webUser = wu.webUser and
wue.levelId = ec.levelId 
