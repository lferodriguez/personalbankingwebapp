Public Class statistics
    ...
    Function getIncomesAndExpensesToCompare(ByVal currency As clsAccount.accountCurrencies,
        ...
        writer.AppendLine("<td colspan=""5"" class=""max_header"">Two months ago</td>")
        writer.AppendLine("<td colspan=""5"" class=""max_header"">Last month</td>")
        writer.AppendLine("<td colspan=""5"" class=""max_header"">This month</td>")
        writer.AppendLine("</tr>")
        writer.AppendLine("<tr>")
